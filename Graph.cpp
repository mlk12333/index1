...
//        HashSet hash(out_pstart[i+1] - out_pstart[i]);
//        for(unsigned int j = out_pstart[i]; j<out_pstart[i+1]; j++){
//            out_vertex a;
//            a.value =j;
...
//                        num_out_f[k] = num_out_f[k] + double_;
//                        num_out_f[j] = num_out_f[j] + double_;
//
//                        //unsigned int j2 = binary_search(out_edges,out_pstart[i],out_pstart[i+1],w);
//                        num_out_f[judge.value] = num_out_f[judge.value] + double_;
//
//                    }
//                }
//
